...
class TestTxtWrpr:
    def test__init__(self, env_setup_self_destruct):
        ...
        t_txtwrpr = txtwrpr.TxtWrpr("TxtWrpr", env_setup.dir)

        assert t_txtwrpr.success
        pass
    ...
    def test_method_1(self, env_setup_self_destruct):
        ...
        assert t_txtwrpr.method_1("THis is a test message for Method_1")
        pass
